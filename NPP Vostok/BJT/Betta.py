...
device_name = dirname+"/"+out_file
if not os.path.isdir(device_name):
    #print "Directory "+str(device_name)+ " is existed";
    #sys.exit(1)
    os.mkdir(device_name,0777)


out_file= device_name + "/Betta_Ue"
...
if INCLUDE_GRAPHICS:
    plt.subplot(211)
    plt.title("Measure Betta versus Ue")
    plt.xlabel("Ue, V")
    plt.ylabel("Betta")
    plt.grid(True)
    ...
    plt.grid(True)
    plt.legend(loc="upper left")
    plt.savefig(out_file+"_betta_vUe.png")
